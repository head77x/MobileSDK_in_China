...
//			_smsPayer = SmsPayCMCC_MM.initSingleton(_context, new SmsPayListener(this, null));
	...
	private final static int opCMCC 		= 0x00000001;
	...
	static public SmsMobileOperator getMobileOperator() {
        ...
        if (operator != null){
            if ((operator.equals("46000") || operator.equals("46002")) && (nSOValue & opCMCC) != opMISMATCHES) {
                // 中国移动
...
//        return SmsMobileOperator.kMOBILE_OPERATOR_UNKNOWN;
		return SmsMobileOperator.kMOBILE_OPERATOR_CMCC_GC;
    }
...
//			Log.e("======移动MM SDK=======", PurchaseCode.getDescription(arg0));
