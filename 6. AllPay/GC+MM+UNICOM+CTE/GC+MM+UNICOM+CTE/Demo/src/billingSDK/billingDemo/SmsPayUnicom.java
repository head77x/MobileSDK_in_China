...
public class SmsPayUnicom extends SmsPayBase
{
	...
	private SmsPayUnicom(UnipayPayResultListener listener) {
		...
		_3RDPayCodes = new String[] { "905885744920130605153305684600008", "905885744920130605153305684600002", "905885744920130605153305684600002", "905885744920130605153305684600002" };
		_props = new String[] { "复活1", "复活2", "复活3", "复活4" };
		_moneys = new String[] { "10", "5", "2", "2" };
		_appid = "905885744920130605153305684600";
		_cpCode = "9058857449";
		_cpId = "86006400";
		_companyName = "XXX公司";
