...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements interfaces.ServicesService {
    ...
    private java.lang.String Services_address = "http://192.168.0.85:10001/CardChargingGW/services/Services";
    ...
    public interfaces.Services getServices() throws javax.xml.rpc.ServiceException {
    ...
    public interfaces.Services getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            interfaces.ServicesSoapBindingStub _stub = new interfaces.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (interfaces.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                interfaces.ServicesSoapBindingStub _stub = new interfaces.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://interfaces", "ServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://interfaces", "Services"));
        }
