...
void js_yijie_SFGameNativeInterface_finalize(JSContext *cx, JSObject *obj);
...
JSBool js_yijie_SFGameNativeInterface_SFGameNativeInterface(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_yijie_SFNativeOnlineUser_SFNativeOnlineUser(JSContext *cx, uint32_t argc, jsval *vp);

JSBool js_yijie_SFNativeOnlineLoginListener_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_yijie_SFNativeOnlineLoginListener_finalize(JSContext *cx, JSObject *obj);
void js_register_yijie_SFNativeOnlineLoginListener(JSContext *cx, JSObject *global);
void register_all_yijie(JSContext* cx, JSObject* obj);
JSBool js_yijie_SFNativeOnlineLoginListener_onLoginFailed(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_yijie_SFNativeOnlineLoginListener_onLoginSuccess(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_yijie_SFNativeOnlineLoginListener_onLogout(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_yijie_SFNativeOnlineLoginListener_SFNativeOnlineLoginListener(JSContext *cx, uint32_t argc, jsval *vp);
#endif
