...
//扩展回调
//class SFNativeIExtendResulBackImp : public SFNativeIExtendResulBack
//{
//	virtual void onResponse(int index, const char* r, const char* remain) {
//		if (index == 1) {
//			resultText->setString("扩展回调1:");
//			log("扩展回调1：%s", r);
//		}
//		if (index == 2) {
//			resultText->setString("扩展回调2:");
//			log("扩展回调2：%s", r);
//		}
//
//	}
...
//初始化回调
/*游戏初始化回调类*/
//class SFNativeInitResulBackImpl: public SFNativeInitResulBack {
...
//SFNativeIExtendResulBackImp extendCallback = SFNativeIExtendResulBackImp();
//SFNativeInitResulBackImpl initCallback = SFNativeInitResulBackImpl();
...
//	 auto payLabel = LabelTTF::create("扩展", "宋体", 40);
//
//	 CCMenuItemLabel* paylabelItem = CCMenuItemLabel::create(payLabel,
//	 this, menu_selector(HelloWorld::menuExtendCallback));
//	 CCMenu* paylabelMenu = CCMenu::create(paylabelItem, NULL);
//	 paylabelMenu->setPosition(ccp(100, 320));
//	 addChild(paylabelMenu, 2);
    /////////////////////////////
	...
	//注册初始化回调类
//	SFGameNativeInterface::setSFInitResulBack(&initCallback);
...
//void HelloWorld::menuExtendCallback(Ref* pSender)
//{
//	SFGameNativeInterface::setSFIExtendResulBack(&extendCallback);
//	const char* s=SFGameNativeInterface::extend("data",2);
//	log("扩展:%s", s);
//}
...
//		SFGameNativeInterface::pay(1, "100金币", 1, "购买金币", CP_PAY_SYNC_URL);
//	} else {
//		stateText->setString("请先登陆");
//	}
