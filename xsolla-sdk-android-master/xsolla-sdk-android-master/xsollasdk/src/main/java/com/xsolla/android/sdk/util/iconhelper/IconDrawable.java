...
import static com.xsolla.android.sdk.util.iconhelper.Util.convertDpToPx;
import static com.xsolla.android.sdk.util.iconhelper.Util.isEnabled;
...
public class IconDrawable extends Drawable {
    ...
    private final IconMaker.IconValue icon;
     ...
     */
    public IconDrawable(Context context, IconMaker.IconValue icon) {
        this.context = context;
        this.icon = icon;
        paint = new TextPaint();
        paint.setTypeface(IconMaker.getTypeface(context));
