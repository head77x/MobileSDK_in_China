...
/// </summary>
public class CmmBillingAndroidDemo : MonoBehaviour
{
    public String AppID;
	...
	void Awake ()
	{
		...
		{
            CmmBillingAndroid.instance.InitializeApp(AppID, AppKey, gameObject.name, "OnBillingResult");
		}
	}
	...
	public void Billing(String index)
    {
        ...
        // 다섯번째 인자는 결과를 받을 함수명
        CmmBillingAndroid.instance.DoBilling(index, "Brandon Test", null, "");
    }
    ...
    void OnBillingResult(String result)
    {
        ...
        if ((int)CmmBillingAndroid.BillingResult.SUCCESS_SMS == int.Parse(results[1]) ||
            (int)CmmBillingAndroid.BillingResult.SUCCESS_SMS_DELAY == int.Parse(results[1]))
        {
            // success
            Debug.Log("Success!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        }
